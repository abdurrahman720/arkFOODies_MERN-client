    ...
    <div className="flex flex-col justify-center items-center p-10 md:flex-row mx-auto  bg-mybg">
      <div className="text-center lg:text-left w-1/2 text-myprimary ">
        <div className="flex flex-col items-center justify-center w-full">
          ...
          <h1 className="text-2xl md:text-5xl font-bold font-custom1 ">
            Taste the global cuisine
          </h1>
        </div>
        <p className="py-6 md:text-2xl font-extrabold font-custom1 ">
       ...
       <Link to='/recipes'> <button className="btn font-custom1 my-2">
          Explore Recipies
        </button></Link>
        <Link to='/addrecipe'><button className="btn font-custom1 ml-4">Share Recipes</button></Link>
      </div>
